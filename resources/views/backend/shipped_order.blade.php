                ...
                <div class="row">
                    <div class="col-lg-12">
                       ...
                       Shipped Order
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Dashboard >>>Shipped Order
                            </li>
                        </ol>
                    </div> 
                </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                        ...
                                        <td>@if($v->discount_amount == null)
                                            Nill
                                            @else
                                        {{number_format($v->discount_amount)}}

                                        @endif</td>
                                            <td>{{$v->updated_at}}</td>
                                        <td><a class="btn btn-success" href="{{url('delivered',$v->id)}}">DELIVERED</a><br/><br/><a href="{{url('returned',$v->id)}}" class="btn btn-danger">RETURN</a></td>
                                    </tr>
                                    </tbody>
