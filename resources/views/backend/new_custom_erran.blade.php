   ...
   <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Dashboard >>> New Custom Erran
                            </li>
                        </ol>
                    </div> 
                </div>
...
@endif</p>
   <p><strong>Detail : </strong>{{$v->detail}}</p> 
      ...
      <a href="{{url('delivered_custom_erran',$v->id)}}"  class="btn btn-success btn-lg">Delivered</a>
      &nbsp;&nbsp; &nbsp;&nbsp;
       <a href="{{url('cancelled_custom_erran',$v->id)}}" class="btn btn-danger btn-lg">Cancelled</a>
      &nbsp;&nbsp; &nbsp;&nbsp;
...
{{ $n->links() }}
 ...
 <div class=" col-sm-10 col-sm-offset-1 alert alert-danger" role="alert" style="z-index: 1000px;">
      <p>  No custom erran is  available </p>
    </div>
