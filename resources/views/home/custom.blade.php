@extends('layout.main')
@section('title','Request Custom Erran')
@section('content')
...
<div class="col-sm-12">
  <div class="breadcrumb" style="margin-bottom:30px;">
                    <a href="{{'/'}}">Home</a> >>>
                    <span class="text-lg">Request Custom Erran</span>
                    </div>
                                 <div class="col-sm-12" style="background-color:#FFA500;margin-bottom:10px;border-radius: 4px; color: #000;">
               <h4 class="text-lg text-center">Custom Erran Request</h4>
               <hr/>
   <form class="form-horizontal" role="form" method="POST" action="{{ url('/custom') }}">
                        {{ csrf_field() }}
                          ...
                          <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4 col-sm-5">
                              <label for="email">Enter Address </label>
                                <textarea id="address" rows="6" type="text" class="form-control" name="address" value="{{ old('address') }}"> </textarea>
                            ...
                            <div class="col-sm-8">
                             <label for="detail">Erran Detail</label>
                                <textarea rows="6" id="address" type="text" class="form-control" name="detail" value="{{ old('detail') }}"> </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <br/><br/>
                                <button type="submit" class="btn btn-default">
                                    <i class="fa fa-btn fa-user"></i> Send Custom Erran
                                </button>
                            </div>
                        </div>
